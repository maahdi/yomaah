...
<body>
    ";
        // line 33
        if ((array_key_exists("literie_admin", $context) && (isset($context["literie_admin"]) ? $context["literie_admin"] : null))) {
            // line 34
            echo "        ";
        ...
        // line 36
        echo "    ";
        if ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session"), "get", array(0 => "mobile"), "method")) {
            // line 37
            echo "    ";
        } else {
            // line 38
