...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'codesource' => 'getCodesourceService',
            ...
            'literie_gestionmenu' => 'getLiterieGestionmenuService',
            'literie_menutwigextension' => 'getLiterieMenutwigextensionService',
            'locale_listener' => 'getLocaleListenerService',
            'logger' => 'getLoggerService',
            'mobile_detect' => 'getMobileDetectService',
            ...
            'yomaah_requete_listener' => 'getYomaahRequeteListenerService',
            'yomaah_security_listener' => 'getYomaahSecurityListenerService',
        );
        $this->aliases = array(
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/srv/http/workspace/euroliterie/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/srv/http/workspace/euroliterie/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/srv/http/workspace/euroliterie/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/srv/http/workspace/euroliterie/app/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'codesource' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Yomaah\codeSourceBundle\Controller\CodeSourceController A Yomaah\codeSourceBundle\Controller\CodeSourceController instance.
     */
    protected function getCodesourceService()
    {
        return $this->services['codesource'] = new \Yomaah\codeSourceBundle\Controller\CodeSourceController();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'euroliterie', 'host' => 'localhost', 'port' => NULL, 'user' => 'yoshi', 'password' => 'martini', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_6f1a01ab4928ef73d4920a2b44a0c480');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6f1a01ab4928ef73d4920a2b44a0c480');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_6f1a01ab4928ef73d4920a2b44a0c480');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/srv/http/workspace/euroliterie/src/Yomaah/structureBundle/Entity', 1 => '/srv/http/workspace/euroliterie/src/Yomaah/connexionBundle/Entity', 2 => '/srv/http/workspace/euroliterie/src/EuroLiterie/structureBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Yomaah\\structureBundle\\Entity');
        $f->addDriver($e, 'Yomaah\\connexionBundle\\Entity');
        $f->addDriver($e, 'EuroLiterie\\structureBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('yomaahBundle' => 'Yomaah\\structureBundle\\Entity', 'YomaahconnexionBundle' => 'Yomaah\\connexionBundle\\Entity', 'EuroLiteriestructureBundle' => 'EuroLiterie\\structureBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/srv/http/workspace/euroliterie/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.request', array(0 => 'yomaah_requete_listener', 1 => 'onKernelRequest'), 0);
        $instance->addListenerService('kernel.request', array(0 => 'mobile_detect', 1 => 'onKernelRequest'), 0);
        ...
        $instance->addSubscriberService('yomaah_security_listener', 'Yomaah\\structureBundle\\Classes\\SecurityListener');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/srv/http/workspace/euroliterie/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '21493d3fc9c5a4b6c95235f5e302d8c6');
    }
    ...
    /**
     * Gets the 'literie_gestionmenu' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return EuroLiterie\structureBundle\Classes\GestionMenu A EuroLiterie\structureBundle\Classes\GestionMenu instance.
     */
    protected function getLiterieGestionmenuService()
    {
        return $this->services['literie_gestionmenu'] = new \EuroLiterie\structureBundle\Classes\GestionMenu($this);
    }

    /**
     * Gets the 'literie_menutwigextension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return EuroLiterie\structureBundle\Classes\MenuTwigExtension A EuroLiterie\structureBundle\Classes\MenuTwigExtension instance.
     */
    protected function getLiterieMenutwigextensionService()
    {
        return $this->services['literie_menutwigextension'] = new \EuroLiterie\structureBundle\Classes\MenuTwigExtension($this->get('literie_gestionmenu'));
    }
    ...
    /**
     * Gets the 'mobile_detect' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Yomaah\structureBundle\Classes\MobileDetect A Yomaah\structureBundle\Classes\MobileDetect instance.
     * 
     * @throws InactiveScopeException when the 'mobile_detect' service is requested while the 'request' scope is not active
     */
    protected function getMobileDetectService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('mobile_detect', 'request');
        }

        return $this->services['mobile_detect'] = $this->scopedServices['request']['mobile_detect'] = new \Yomaah\structureBundle\Classes\MobileDetect($this->get('session'), $this->get('request'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/srv/http/workspace/euroliterie/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/srv/http/workspace/euroliterie/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/srv/http/workspace/euroliterie/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/srv/http/workspace/euroliterie/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Yomaah\\connexionBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha256', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.main')), 'secured_area', $a, $c), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'secured_area', $l, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $j, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '53219d084db88', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $j, '/login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/srv/http/workspace/euroliterie/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/srv/http/workspace/euroliterie/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/srv/http/workspace/euroliterie/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/srv/http/workspace/euroliterie/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/srv/http/workspace/euroliterie/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/srv/http/workspace/euroliterie/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/srv/http/workspace/euroliterie/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/srv/http/workspace/euroliterie/app', 'UTF-8'));
        ...
        $instance->addExtension($this->get('literie_menutwigextension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/srv/http/workspace/euroliterie/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/srv/http/workspace/euroliterie/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/srv/http/workspace/euroliterie/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/srv/http/workspace/euroliterie/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/srv/http/workspace/euroliterie/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/srv/http/workspace/euroliterie/src/Yomaah/structureBundle/Resources/views', 'yomaah');
        $instance->addPath('/srv/http/workspace/euroliterie/src/Yomaah/codeSourceBundle/Resources/views', 'YomaahcodeSource');
        $instance->addPath('/srv/http/workspace/euroliterie/src/Yomaah/connexionBundle/Resources/views', 'Yomaahconnexion');
        $instance->addPath('/srv/http/workspace/euroliterie/src/Yomaah/ajaxBundle/Resources/views', 'Yomaahajax');
        $instance->addPath('/srv/http/workspace/euroliterie/src/EuroLiterie/structureBundle/Resources/views', 'EuroLiteriestructure');
        $instance->addPath('/srv/http/workspace/euroliterie/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/srv/http/workspace/euroliterie/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/srv/http/workspace/euroliterie/app/Resources/views');
        $instance->addPath('/srv/http/workspace/euroliterie/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('21493d3fc9c5a4b6c95235f5e302d8c6');
    }
    ...
    /**
     * Gets the 'yomaah_requete_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Yomaah\structureBundle\Classes\RequeteListener A Yomaah\structureBundle\Classes\RequeteListener instance.
     */
    protected function getYomaahRequeteListenerService()
    {
        return $this->services['yomaah_requete_listener'] = new \Yomaah\structureBundle\Classes\RequeteListener($this->get('doctrine.dbal.default_connection'), $this->get('security.context'));
    }

    /**
     * Gets the 'yomaah_security_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Yomaah\structureBundle\Classes\SecurityListener A Yomaah\structureBundle\Classes\SecurityListener instance.
     */
    protected function getYomaahSecurityListenerService()
    {
        return $this->services['yomaah_security_listener'] = new \Yomaah\structureBundle\Classes\SecurityListener($this->get('security.context'), $this->get('router'), $this->get('event_dispatcher'), $this->get('doctrine.dbal.default_connection'), $this->get('session'));
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/srv/http/workspace/euroliterie/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/srv/http/workspace/euroliterie/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Yomaah\\connexionBundle\\Entity\\User', 'login', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/srv/http/workspace/euroliterie/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/srv/http/workspace/euroliterie/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/srv/http/workspace/euroliterie/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/srv/http/workspace/euroliterie/app/cache/dev',
            'kernel.logs_dir' => '/srv/http/workspace/euroliterie/app/logs',
            'kernel.bundles' => array(
                ...
                'yomaahBundle' => 'Yomaah\\structureBundle\\yomaahBundle',
                'YomaahcodeSourceBundle' => 'Yomaah\\codeSourceBundle\\YomaahcodeSourceBundle',
                'YomaahconnexionBundle' => 'Yomaah\\connexionBundle\\YomaahconnexionBundle',
                'YomaahajaxBundle' => 'Yomaah\\ajaxBundle\\YomaahajaxBundle',
                'EuroLiteriestructureBundle' => 'EuroLiterie\\structureBundle\\EuroLiteriestructureBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'euroliterie',
            'database_user' => 'yoshi',
            'database_password' => 'martini',
            'mailer_password' => NULL,
            'locale' => 'fr',
            'secret' => '21493d3fc9c5a4b6c95235f5e302d8c6',
            ...
            'debug.container.dump' => '/srv/http/workspace/euroliterie/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '21493d3fc9c5a4b6c95235f5e302d8c6',
            ...
            'session.save_path' => '/srv/http/workspace/euroliterie/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/srv/http/workspace/euroliterie/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/srv/http/workspace/euroliterie/app/cache/dev/profiler',
            ...
            'router.resource' => '/srv/http/workspace/euroliterie/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/srv/http/workspace/euroliterie/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.sfr.fr',
            ...
            'assetic.cache_dir' => '/srv/http/workspace/euroliterie/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/srv/http/workspace/euroliterie/app/../web',
            'assetic.write_to' => '/srv/http/workspace/euroliterie/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/srv/http/workspace/euroliterie/app/cache/dev/doctrine/orm/Proxies',
